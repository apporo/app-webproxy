...
var debugx = Devebot.require('debug')('appWebrouter:storage');
...
var Service = function(params) {
  ...
  debugx.enabled && debugx(' - mappingStoreRef: %s', JSON.stringify(mappingStoreRef));
  ...
  var ready = function() {
    ...
    return Promise.resolve().then(function() {
      if (declaredRuleRef == null) {
        ...
        debugx.enabled && debugx(' - declaredRuleRef ~ internal config: %s', JSON.stringify(declaredRuleRef));
        return confighub.loadConfig().then(function(externalConfig) {
          ...
          debugx.enabled && debugx(' - declaredRuleRef ~ external config: %s', JSON.stringify(declaredRuleRef));
